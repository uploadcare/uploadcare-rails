...
<head>
  ...
  <%= csrf_meta_tags %>
  <%= include_uploadcare_widget_from_cdn version: "2.10.1", min: true %>
  <!--
    results in:
    <script src="https://ucarecdn.com/widget/2.10.1/uploadcare/uploadcare.full.min.js"></script>
  -->
</head>
```
### Download and append widget manually to your pipeline.

You may download (e.g. https://ucarecdn.com/widget/2.10.1/uploadcare/uploadcare.full.min.js) and serve the widget yourself along with your other assets.
